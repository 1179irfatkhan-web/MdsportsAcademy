    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('Judo', 'Judo'), ('Wrestling', 'Wrestling'), ('MMA', 'MMA'), ('athletic', 'athletic'), ('badminton', 'badminton'), ('softball', 'softball'), ('KABADI', 'KABADI'), ('KHO-KHO', 'KHO-KHO')], max_length=100)),
