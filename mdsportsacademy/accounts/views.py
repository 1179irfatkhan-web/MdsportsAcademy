...
class RegisterCoachView(CreateView):
    """
       Provides the ability to register as a Coach.
    """
    model = User
    form_class = CoachRegistrationForm
    template_name = 'accounts/coach/register.html'
    success_url = '/'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, 'accounts/coach/register.html', {'form': form})
